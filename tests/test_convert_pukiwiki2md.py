...
|BGCOLOR(#C0C0C0):COLOR(#000000):LLL-002|BGCOLOR(#C0C0C0):COLOR(#000000):試作品、廃版|BGCOLOR(#C0C0C0):COLOR(#000000): 電源|BGCOLOR(#C0C0C0):COLOR(#000000): なし |BGCOLOR(#C0C0C0):COLOR(#000000):タップ|
''') == '''
||||||c
|~型名|~生産状況|~内容|~RTC|~備考|
|LLL-001|量産品| 電源基板| なし |端子|
|LLL-002|試作品、廃版| 電源| なし |タップ|
'''
    assert convert_pukiwiki2md.table_attr('''
